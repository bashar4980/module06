...
const person = {
    playCricket: true ,
    playFoodball : false ,
    educationInstitute :['kbh' , 'Nimtola College' , 'Islamic University'],
    biodata:{
        name: "Bashar Ahmed",
        age: 24 ,
        villege: 'katlamari',
    ...
    fullName : function(){
        console.log(this)
        return `I am ${this.biodata.name}. I am ${this.biodata.age}`
    }
}

// const bio = person.fullName() ;
// console.log(bio)
...
const userBio = `My name is ${person.biodata.name}. I read in ${person.educationInstitute[01]} . I love play ${person.playCricket}` ;
// console.log(userBio);
...
const getDiviser = num => num/17;
// console.log(getDiviser(85));
